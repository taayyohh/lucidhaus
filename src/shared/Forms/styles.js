...
export const genericFormStyle = {
    ...
    paddingTop: [50, globals.style.layoutScalingValue, 30],
    paddingBottom: [80, globals.style.layoutScalingValue, 30],
    paddingLeft: [80, globals.style.layoutScalingValue, 30],
    paddingRight: [80, globals.style.layoutScalingValue, 30],
    background: '#fcfcfc',
