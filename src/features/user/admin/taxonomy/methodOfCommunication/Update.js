import {methodOfCommunicationField, validateMethodOfCommunication} from 'features/user/admin/taxonomy/methodOfCommunication/fields'
...
const Update = () => {
    ...
    const {name, description, type} = methodOfCommunication
    ...
    useEffect(() => {
        dispatch({
            type: 'user/getMethodOfCommunication',
            payload: {
                slug: slug
            }
        })
