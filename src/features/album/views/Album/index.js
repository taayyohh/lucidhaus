...
import {getById, getNameById, resolvedPromise} from 'utils/helpers'
import {
                                        ...
                                        <Div theme={albumSongsWrapperStyle}>
                                            {songs && songs.map((s) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Div theme={albumSongWrapperStyle(isActive)}>
                                                                <Div>
                                                                    <Span
                                                                        theme={albumSongTrackNumberStyle}>{s.trackNumber}</Span>
                                                                    <Span>{s.title}</Span>
                                                                </Div>
                                                                {isActive && (
                                                                    <MotionDiv
